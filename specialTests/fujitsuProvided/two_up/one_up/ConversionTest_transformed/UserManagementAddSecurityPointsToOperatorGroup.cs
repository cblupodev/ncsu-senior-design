...
{
    public class UserManagementAddSecurityPointsToOperatorGroup : IScenario
    {
        public void Start()
        {
        ...
        public UserManagementAddSecurityPointsToOperatorGroup(IController controller, IUserManagementSettings settings)
        {
