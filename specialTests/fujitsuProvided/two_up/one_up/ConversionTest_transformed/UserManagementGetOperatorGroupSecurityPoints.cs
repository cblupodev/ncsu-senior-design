...
{
    public class UserManagementGetOperatorGroupSecurityPoints : IScenario
    {
        public void Start()
        {
            ...
            {
                var result = proxy.ExecuteReadOperation(new GetOperatorGroupSecurityPointsOperation
                {
        ...
        public UserManagementGetOperatorGroupSecurityPoints(IController controller, IUserManagementSettings settings)
        {
